(() => {
  ...
  function loadInfoBoxes() {
    ...
    fetch(infoBox)
      ...
      .then(data => {
        removeSpinner(); // Remove the spinner on call after load
        data.forEach((infoBox, index) => {
          ...
          imageElement.src = '../images/earbud.jpg'; // could not edit api so created an element
      ...
      .catch(error => {
        ...
        errorMessageElement.textContent = '404, 404, 404. Please try again later.';

        // Append the error message 
        peopleCon.innerHTML = '';
        peopleCon.appendChild(errorMessageElement);
  ...
  function loadMaterialInfo() {
    ...
    fetch(materials)
      ...
      .catch(error => console.error('Error loading materialListData:', error));
  }
